...
<!-- Table-->
   <table class="table table-bordered" id="datos">
       ...
       <tbody>
           @foreach($herramientas as $mtip)
               <tr>
                   <td>{{ $mtip->id }}</td>
                   <td>{{ $mtip->nombre }}</td>
                   @foreach($tipherra as $mtiph)
                        @if($mtiph->id==$mtip->tipherra_id)
                            <td>{{ $mtiph->nombre }}</td>
                        @endif
                   @endforeach
       ...
       <div class="modal-body">
           <div class="row">
               ...
               <div class="col-sm-12">
                   ...
                   <div class="col-sm-8">
                       <select name="tipherra_id" id="tipherra_id" class="form-control">
       ...
       <div class="modal-body">
           ...
           <div class="row">
               ...
               <div class="col-sm-12">
                ...
                <div class="col-sm-8">
                    <select name="tipherra_idedi" id="tipherra_idedi" class="form-control">
                        <option value="">---Selecione---</option>
                        @foreach($tipherra as $mtip)
                             <option value="{{ $mtip->id }}">{{ $mtip->nombre }}</option>
                        @endforeach
...
@section('script')
<script src="{{ asset('/js/Herramientas/index.js') }}" type="text/javascript"></script>
