   ...
   <div class="modal-dialog">
     <div class="modal-content">
       <div class="modal-header">
         ...
         <h4 class="modal-title">Crear Tipo de Dificultad</h4>
       </div>
...
<div class="modal fade" id="editar" role="dialog">
   <div class="modal-dialog">
     <div class="modal-content">
       <div class="modal-header">
         <button type="button" class="close" data-dismiss="modal">&times;</button>
         <h4 class="modal-title">Editar Tipo de Dificultad</h4>
       </div>
...
@section('script')
<script src="{{ asset('/js/Tipdificultad/index.js') }}" type="text/javascript"></script>
